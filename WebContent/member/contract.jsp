...
<article>
    <form id="join" name="contractFrm" method="post">
        ...
        <div style="text-align: center;">
            <label for="okon1_1">
                <input type="radio" name="okon1" value="1" id="okon1_1">동의함 &nbsp;&nbsp;&nbsp;
            </label>
            <label for="okon1_2">
                <input type="radio" name="okon1" value="2" id="okon1_2" checked>동의안함
            </label>
